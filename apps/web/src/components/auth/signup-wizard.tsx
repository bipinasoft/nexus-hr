  ...
  return (
    <div className="grid gap-6 lg:grid-cols-[1.02fr_0.98fr]">
            ...
            return (
              <button
                className={`rounded-full px-4 py-2 text-sm font-semibold transition ${
                  active ? "bg-violet-700 text-white" : "bg-slate-100 text-slate-600 hover:bg-violet-50"
                }`}
                key={item.id}
      ...
      <aside className="panel-dark px-6 py-6 md:px-8">
        <p className="text-xs uppercase tracking-[0.25em] text-violet-200">Launch blueprint</p>
